# demo-site
Small boilerplate 3D Graphics setup usng WebGl 2. Does all the goundwork from loading models and shaders to tracking objects and cameras around.
Didn't use three.js because I just like vanilla.js better, together with the learning experience.
This needs some cleanup and and more documentatin, but should serve at least at demonstrating, that I can work some nice code.
# Looking for a job
